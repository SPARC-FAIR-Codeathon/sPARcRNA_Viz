...
import tsne_data_json from "../data/tsne_data.json";
import cluster_info_json from "../data/cluster_info.json";
import gsea_results_json from "../data/gsea_results.json";
...
export function generateGseaInfo(pathway) {
...
export function drawSVG(data, clusterInfo) {
...
async function main() {
  try {
    const [tsneData, clusterInfo, gseaResults] = [
      tsne_data_json,
      cluster_info_json,
      gsea_results_json,
    ];
